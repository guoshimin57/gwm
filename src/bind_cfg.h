...
/*  功能轉換鍵掩碼  鍵符號        要綁定的函數              函數的參數 */         
    ...
    {WM_KEY,        XK_Up,        key_less_height,         {0}},                  
    {WM_KEY,        XK_Down,      key_more_height,         {0}},                  
    {WM_KEY,        XK_Left,      key_less_width,          {0}},                  
    {WM_KEY,        XK_Right,     key_more_width,          {0}},                  
    {WM_KEY,        XK_F1,        change_to_main,          {0}},                  
    {WM_KEY,        XK_F2,        change_to_second,        {0}},                  
    {WM_KEY,        XK_F3,        change_to_fixed,         {0}},                  
    {WM_KEY,        XK_F4,        change_to_above,         {0}},                  
...
{                                                                                         
    ...
    {FLOAT_BUTTON,              0, Button1,  change_to_above,      {0}},                  
