...
{
    DEFAULT_FONT, TITLEBAR_FONT, ACT_CENTER_FONT, TASKBAR_FONT,
...
enum ewmh_atom_tag // EWMH規範的標識符
{
    ...
    NET_MOVERESIZE_WINDOW, NET_WM_MOVERESIZE, 
    NET_WM_MOVERESIZE_SIZE_RIGHT,
    NET_RESTACK_WINDOW,
    NET_REQUEST_FRAME_EXTENTS, NET_WM_NAME, NET_WM_DESKTOP,
    NET_WM_WINDOW_TYPE, NET_WM_WINDOW_TYPE_NORMAL, NET_WM_WINDOW_TYPE_DIALOG,
    NET_WM_WINDOW_TYPE_UTILITY,
    NET_WM_STATE, NET_WM_STATE_MODAL, NET_WM_STATE_STICKY,
    NET_WM_STATE_MAXIMIZED_VERT, NET_WM_STATE_MAXIMIZED_HORZ,
    NET_WM_STATE_SHADED, NET_WM_STATE_SKIP_TASKBAR,
    NET_WM_STATE_PAGER, NET_WM_STATE_HIDDEN, NET_WM_STATE_FULLSCREEN,
    NET_WM_STATE_ABOVE, NET_WM_STATE_BELOW,
    NET_WM_STATE_DEMANDS_ATTENTION, NET_WM_STATE_FOCUSED,
    NET_WM_ICON, EWMH_ATOM_N
};
...
enum widget_color_tag // 構件顏色類型
{
    ...
    ACT_CENTER_COLOR, TASKBAR_COLOR, ENTRY_COLOR, HINT_WIN_COLOR,
...
enum text_color_tag // 文本顏色類型
{
    ...
    TASKBAR_TEXT_COLOR, CLASS_TEXT_COLOR, ACT_CENTER_ITEM_TEXT_COLOR,
