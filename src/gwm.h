...
{ \
    ...
    "_NET_DESKTOP_GEOMETRY", "_NET_CLIENT_LIST_STACKING", \
...
enum widget_type_tag // 構件類型
{
    ...
    IN_SITU_VERT_MAX_BUTTON, IN_SITU_HORZ_MAX_BUTTON, TOP_MAX_BUTTON,
    ...
    CLIENT_MENU_ITEM_BEGIN=IN_SITU_VERT_MAX_BUTTON, CLIENT_MENU_ITEM_END=FULL_MAX_BUTTON, 
};
...
enum ewmh_atom_tag // EWMH規範的標識符
{
    ...
    NET_DESKTOP_GEOMETRY, NET_CLIENT_LIST_STACKING, NET_CURRENT_DESKTOP,
    ...
    NET_WM_STATE_SKIP_TASKBAR, NET_WM_STATE_PAGER, NET_WM_STATE_HIDDEN,
    NET_WM_STATE_FULLSCREEN, NET_WM_STATE_ABOVE, NET_WM_STATE_BELOW,
    NET_WM_STATE_DEMANDS_ATTENTION, NET_WM_STATE_FOCUSED, NET_WM_ICON,
    EWMH_ATOM_N
};
...
{
    IN_SITU_VERT_MAX, IN_SITU_HORZ_MAX,
